...
export function AboutContent({ showLogo = true }: { showLogo?: boolean }) {
  return (
    <div className="space-y-6">
      {showLogo && (
        <div className="flex items-center gap-4">
          ...
          />
          <div>
            <h2 className="text-2xl font-semibold">About Cadence</h2>
      ...
      <div>
        <h3 className="text-base font-semibold mb-3">What each page does</h3>
